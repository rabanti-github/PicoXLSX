...
namespace Demo
{
    class Program
    {
        ...
        private static void BasicDemo()
        {
            ...
            Style s = new Style();
            s.CurrentNumberFormat.Number = NumberFormat.FormatNumber.format_22;
            workbook.CurrentWorksheet.AddNextCell(DateTime.Now, s);
            workbook.Save();
        }
        ...
        private static void Demo1()
        {
            ...
            Address address = new Address(1, 0, AddressType.Default);            // Create Address with default behavior
            ...
            address = new Address(1, 1, AddressType.FixedColumn);                     // Create Address with fixed column
            ...
            address = new Address(1, 2, AddressType.FixedRow);                        // Create Address with fixed row
            ...
            address = new Address(1, 3, AddressType.FixedRowAndColumn);               // Create Address with fixed row and column
