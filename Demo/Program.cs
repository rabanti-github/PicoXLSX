...
namespace Demo
{
    static class Program
    {
        ...
        private static void Demo8()
        {
            ...
            workbook.CurrentWorksheet.AddSelectedCells(range);                                          // Set the selection to the range (deprecated method to clear all previous definitions)
        ...
        private static void Demo12()
        {
            ...
            wb.CurrentWorksheet.SetHorizontalSplit(1, true, new Address("A2"), Worksheet.WorksheetPane.BottomLeft);      // Split and freeze worksheet horizontally by rows
