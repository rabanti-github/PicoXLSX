    ...
    <body>
      <main>
        ...
        <h1>
          ...
          <p class=""version"">Version 3.4.5</p>
        ...
        <h1>
            <img src=""PicoXLSX.png""
                 alt=""PicoXLSX""
                 style=""height:48px; vertical-align:middle; margin-right:10px;"">
            {EscapeHtml(rootConfig.ProjectName)} v4.x
        </h1>
...
";
            ...
            var assetDest = Path.Combine(outDir, "PicoXLSX.png");

            string assetSrc = "../Docs.IndexGenerator/Assets/PicoXLSX.png";
            if (File.Exists("../Docs.IndexGenerator/Assets/PicoXLSX.png"))
            {
