...
&ast;) The only requirement to compile the library besides .NET is the assembly **WindowsBase**. This assembly is a <b>standard component in all Microsoft Windows systems</b> (except Windows RT systems) and can be found most likely under "c:\Program Files\Reference Assemblies\Microsoft\Framework\v3.0\WindowsBase.dll", according this [MSDN Blog entry](http://blogs.msdn.com/b/dmahugh/archive/2006/12/14/finding-windowsbase-dll.aspx) if you have installed Microsoft Visual Studio. Otherwiese you can find it in the GLobal Assembly Cache (**GAC**) of Windows, under "c:\Windows\Microsoft.NET\assembly\GAC_MSIL\WindowsBase".<br><br>
